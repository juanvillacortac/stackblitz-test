...
@Component({
  selector: 'app-product-return-top',
  templateUrl: './product-return-top.component.html',
  styleUrls: ['./product-return-top.component.scss']
})
export class ProductReturnTopComponent implements OnInit {
  ...
  loaddata(){
    ...
    this.titleout1='Top 5 de ultimas ordenes';
    this.dataViewModelBuyer = {   
      ...
      dataviewlist:[
        ...
        { id: 2,image: false,mainDescription:'',mainDescriptionSide:'En Borrador',name:'ODC-001-0000222',secundaryDescription:'',secundaryDescriptionSide:'Fecha creada:01-10-2021',imagePath:'assets/layout/images/topbar/avatar-cayla.png'},
        { id: 3,image: false,mainDescription:'',mainDescriptionSide:'En Borrador',name:'ODC-001-0000222',secundaryDescription:'',secundaryDescriptionSide:'Fecha creada:01-10-2021',imagePath:'assets/layout/images/topbar/avatar-gaspar.png'},
        { id: 4,image: false,mainDescription:'',mainDescriptionSide:'Elaborada',name:'ODC-001-0000222',secundaryDescription:'',secundaryDescriptionSide:'Fecha creada:01-10-2021',imagePath:'assets/layout/images/topbar/avatar-cayla.png'},
        { id: 5,image: false,mainDescription:'',mainDescriptionSide:'Planificada',name:'ODC-001-0000222',secundaryDescription:'',secundaryDescriptionSide:'Fecha creada:01-10-2021',imagePath:'assets/layout/images/topbar/avatar-cayla.png'},
