...
export class FilterPurchaseOrderComponent implements OnInit {
  ...
  @Output("onSearch") onSearch = new EventEmitter<FilterPurchaseOrder>();
  ...
  search() {
    ...
    this.filters.idDestBranch= this.filters.idDestBranch==null ? -1: this.filters.idDestBranch;
    this.filters.idTypeDistribution =this.filters.idTypeDistribution ==null ? -1 : this.filters.idTypeDistribution;
    ...
    this.filters.indPartialdelivery = this.filters.indPartialdelivery == null ? -1 : this.filters.indPartialdelivery;
  ...
  ValidatenumberOC() {
    this.filters.numberOC = "";
    if (this.numOCwritte.length > 0) {
      for (let i = 0; i < this.numOCwritte.length; i++) {
        this.filters.numberOC = this.filters.numberOC == "" ? this.numOCwritte[i] : this.filters.numberOC + "," + this.numOCwritte[i];
      }
    }
  }
